...
class Admin {
	...
	public function add_inter_bank_admin_options( $options ) {
		$new_options = array(
			...
			'pix_automatico_gateway_max_value' => '',
			'pix_automatico_gateway_periodicity' => '',
		);
			...
			<div class="popup-content popup-lg">
				...
				<table class="form-table">
					<tbody>
						...
						<tr class="require-enabled-inter-pix-automatico">
							<th>
								<?php echo esc_html( 'Valor máximo', 'module-inter-bank-for-flexify-checkout' ); ?>
								<span class="flexify-checkout-description"><?php echo esc_html__( 'Valor máximo permitido por cobrança.', 'module-inter-bank-for-flexify-checkout' ) ?></span>
							</th>
							<td>
								<input type="number" class="form-control input-control-wd-10" name="pix_automatico_gateway_max_value" value="<?php echo Admin_Options::get_setting('pix_automatico_gateway_max_value' ) ?>"/>
							</td>
						</tr>

						<tr class="require-enabled-inter-pix-automatico">
							<th>
								<?php echo esc_html( 'Periodicidade (dias)', 'module-inter-bank-for-flexify-checkout' ); ?>
								<span class="flexify-checkout-description"><?php echo esc_html__( 'Intervalo em dias entre cada cobrança automática.', 'module-inter-bank-for-flexify-checkout' ) ?></span>
							</th>
							<td>
								<input type="number" class="form-control input-control-wd-5" name="pix_automatico_gateway_periodicity" value="<?php echo Admin_Options::get_setting('pix_automatico_gateway_periodicity' ) ?>"/>
							</td>
						</tr>
