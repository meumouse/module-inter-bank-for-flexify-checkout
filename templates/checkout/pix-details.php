...
<section id="<?php echo esc_attr( $id ); ?>-thankyou">
	...
	<h3 class="flexify-checkout-interpix-title">
		<?php esc_html_e( 'Aguardando sua transferência via Pix', 'module-inter-bank-for-flexify-checkout' ); ?>
	</h3>
	...
	<?php if ( isset( $order ) && $is_email ) : ?>
		<div class="flexify-checkout-interpix-open-browser-container">
			<a href="<?php echo esc_url( $pix_details_page ); ?>" class="flexify-checkout-interpix-open-browser">
				<?php esc_html_e( 'Ver QR Code no navegador', 'module-inter-bank-for-flexify-checkout' ); ?>
			</a>
		</div>
	<?php endif; ?>
	...
	<div class="flexify-checkout-interpix-container">
		<?php if ( ! $is_email && $pix_image ) : ?>
			<div class="qr-code">
				<img class="flexify-checkout-pix qr-code" src="<?php echo esc_attr( $pix_image ); ?>" alt="<?php esc_html_e( 'QR Code para pagamento', 'module-inter-bank-for-flexify-checkout' ); ?>" />
			</div>
		<?php endif; ?>
		...
		<div class="flexify-checkout-interpix-instructions">
			<ul>
				<li>
					<span class="inter-pix-step-instructions">1</span>
					<div>
						<?php echo __( 'Abra o app do seu banco ou instituição financeira e <strong>entre no ambiente Pix</strong>.', 'module-inter-bank-for-flexify-checkout' ); ?>
					</div>
				</li>

				<li>
					<span class="inter-pix-step-instructions">2</span>
					<div>
						<?php
						if ( $is_email || ! $pix_image ) :
				...
				<li>
					<span class="inter-pix-step-instructions">3</span>
					<div>
	...
	<div class="flexify-checkout-interpix-copy-paste">
		<h3 class="flexify-checkout-interpix-copy-title">
			<?php esc_html_e( 'Pix Copia e cola', 'module-inter-bank-for-flexify-checkout' ); ?>
			<?php if ( ! $is_email ) :
				echo '<span class="pix-copy pix-copy-button" data-clipboard-target="#interpix-payload">' . esc_html__( 'Clique para copiar', 'module-inter-bank-for-flexify-checkout' ) . '</span>';
			endif; ?>
		</h3>
